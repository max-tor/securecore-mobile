...
import {avatar, headerBg} from '@/components/common/Icon/icons';
import {
  ...
  return (
    <LinearGradient
      ...
      <Animated.View
        ...
        <DashboardHeaderBg resizeMode="cover" source={headerBg} />
      </Animated.View>
      ...
      <DashboardHeaderTitles>
        <Animated.View style={[styles.container, opacityAnimation]}>
          <DashboardHeaderTitle>My Dashboard</DashboardHeaderTitle>
          <DashboardHeaderSubTitle>
